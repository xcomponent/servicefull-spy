...
export class SessionXCSpy {
  private promiseCreateSession: Promise<Session> | null = null;
  ...
  get PromiseCreateSession(): Promise<Session> {
    if (this.promiseCreateSession == null) {
      throw new Error("XComponent session is not initialized");
    }
